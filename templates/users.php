...
<main class="position-absolute absoluteCenter bg-light text-center p-5 rounded boxShadow">
    ...
    <button class="yellowButton text-nowrap mb-1"><a href="/reset">Mot de passe oublié</a></button>
        ...
        foreach ($users as $user) {
            ...
            <div class="row row-cols-1">
                ...
                <div class="col d-flex justify-content-center">
                    <button class="yellowButton"><a href="/edit/id/<?=$user["id"]?>">Modifier</a></button>
                    <form action="/users/function/delete" method="POST" onsubmit="return confirmDelete()">
